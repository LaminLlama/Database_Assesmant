...
if(isset($_POST['find_series']))

{

//retrieves series and sanitizes it.
$series=test_input(mysqli_real_escape_string($dbconnect,$_POST['series']));

$showall_sql="SELECT * FROM `movie_reviews` WHERE `Series` LIKE 
